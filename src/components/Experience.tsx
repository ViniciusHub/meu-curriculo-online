export default function Experience() {
  return (
    <section id="experiencia" className="bg-white/40 py-10 md:py-20">
        ...
        <div className="space-y-8">
          <div className="grid gap-4 md:grid-cols-[1fr_40px_1fr] md:items-center">
            ...
            <div className="hidden items-center justify-center md:flex">
              <div className="h-4 w-4 rounded-full bg-[#0b2341]" />
            </div>
          ...
          <div className="grid gap-4 md:grid-cols-[1fr_40px_1fr] md:items-center">
            ...
            <div className="hidden items-center justify-center md:flex">
              <div className="h-4 w-4 rounded-full bg-[#59e3d2]" />
            </div>
          ...
          <div className="grid gap-4 md:grid-cols-[1fr_40px_1fr] md:items-center">
            ...
            <div className="hidden items-center justify-center md:flex">
              <div className="h-4 w-4 rounded-full bg-[#111827]" />
            </div>
